...
int main()
{
    ...
    conv_layer_t * layer1 = new conv_layer_t( 1, 7, 10, cases[0].data.size );		
    ...
    long ic = 0, ic_test = 0;
    double err_train = 0, err_validation = 0;
    int max_epochs = 100;
    ...
    for ( int ep = 1; ep <= max_epochs; ep++)
    {
        ...
        err_train = amse/ic;
        cout << "Train " << ep << " err=" << err_train << endl;
        ...
        err_validation = amse_test/ic_test;
        cout << "Validation " << ep << " err=" << err_validation << "\n" << endl;

        if (err_train < err_validation) break;
